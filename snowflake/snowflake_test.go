...
//******************************************************************************
// General Test funcs
var conf = NewNodeConf(1288834974657, 10, 12)

func TestNewNode(t *testing.T) {

	_, err := NewNode(0, &conf)
	if err != nil {
		t.Fatalf("error creating NewNode, %s", err)
	}

	_, err = NewNode(5000, &conf)
	if err == nil {
