...
// IDs
func NewNode(node int64, conf *NodeConf) (*Node, error) {
	...
	n := Node{}
	n.node = node
	n.nodeMax = -1 ^ (-1 << conf.NodeBits)
	n.nodeMask = n.nodeMax << conf.StepBits
	n.stepMask = -1 ^ (-1 << conf.StepBits)
	n.timeShift = conf.NodeBits + conf.StepBits
	n.nodeShift = conf.StepBits
	...
	n.epoch = curTime.Add(time.Unix(conf.Epoch/1000, (conf.Epoch%1000)*1000000).Sub(curTime))
...
func (f ID) Time(n *NodeConf) int64 {
	return (int64(f) >> n.timeShift) + n.Epoch
}

// Node returns an int64 of the snowflake ID node number
// DEPRECATED: the below function will be removed in a future release.
func (f ID) Node(n *NodeConf) int64 {
	return int64(f) & n.nodeMask >> n.nodeShift
}

// Step returns an int64 of the snowflake step (or sequence) number
// DEPRECATED: the below function will be removed in a future release.
func (f ID) Step(n *NodeConf) int64 {
